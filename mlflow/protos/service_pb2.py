...
_RUNDATA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='metric_minimums', full_name='mlflow.RunData.metric_minimums', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='metric_maximums', full_name='mlflow.RunData.metric_maximums', index=4,
...
_RUNDATA.fields_by_name['metric_minimums'].message_type = _METRIC
_RUNDATA.fields_by_name['metric_maximums'].message_type = _METRIC
